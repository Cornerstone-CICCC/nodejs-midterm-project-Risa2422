  ...
  private recipes: Recipe[] = [
    {
      ...
      difficulty: "Medium",
      image:
        "https://res.cloudinary.com/do9wpvadq/image/upload/v1731798360/pexels-quang-nguyen-vinh-222549-2133989_ntzp4l.jpg",
      date: new Date("2024-11-16T12:00:00Z"),
      price: 10,
      about:
        "Pho is a traditional Vietnamese noodle soup made with a flavorful broth, rice noodles, and either beef or chicken. It's served with fresh herbs, and bean sprouts, offering a delicious and customizable meal.",
      ingredients: `・4 lbs beef bones (with marrow)\n・1onion, halved\n・1piece of ginger (about 3 inches), halved\n・3-4 star anise\n・1 cinnamon stick\n・4-5 cloves\n・1-2 cardamom pods (optional)\n・2-3 teaspoons fish sauce\n・1 tablespoon sugar\n・Salt to taste`,
